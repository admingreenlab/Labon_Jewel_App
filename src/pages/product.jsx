                                        ...
                                        <IonCol>
                                            ...
                                            <div className='productreduio'>
                                                ...
                                                <IonTextarea
                                                    ...
                                                    style={{ color: '#201d1d', height: '70px', fontSize: '14px',border:"1px solid gray", borderRadius:"5px", padding:"5px" }}
                                                ></IonTextarea>
                                                    ...
                                                    <div className='main-coune' style={{ display: 'flex', alignItems: 'center', margin: '10px 0', fontFamily: 'Poppins' }}>
                                                        ...
                                                        < button fill="clear" size='large' onClick={incrementCounter} >
                                                            <div style={{ background: '#fff6ec', border: '2px solid rgb(159 153 147)', padding: '8px 13px', borderRadius: ' 0px 5px 5px 0px' }}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                                                ...
                                                <div className='adtocard'>
                                                    <button className='addticaed' expand="block" onClick={(e) => handleAddToCart(e, _id)} style={{ marginTop: '10px', padding: '10px', width: '100%', background: 'rgb(243, 164, 28)', border: '1px solid #00000036',color:"white" }}>ADD  TO   CART</button>
                                                </div>
            ...
            {showModal && (
                <div className="modalimage1">
                    <div className="modalimage2">
                        <div type='button' onClick={closeModal} style={{ position: "absolute", right: "20px", top: "20px", zIndex: "99999999" }}>
